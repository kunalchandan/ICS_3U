import java.util.*;
public class KunalChandanShapeBetter
{
  public static void main(String[]args)
  {
    ...
    System.out.printf("%n%s%23d", "Vertical Line", vCount);
    System.out.printf("%n%s%27d", "Rectangle", rCount);
    System.out.printf("%n%s%5d", "Left slant right angle triangle", ltCount);
    System.out.printf("%n%s%18d", "Isosceles triangle", itCount);
    System.out.println("");
